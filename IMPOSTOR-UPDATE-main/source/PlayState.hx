	...
	override public function create()
	{
		...
		switch(curStage.toLowerCase()){
			...
			case 'monotone':
				...
				darkMono = new FlxSprite(0, 0).makeGraphic(1280, 720, FlxColor.BLACK);
		...
		// made by CoolingTool: https://github.com/Clowfoe/IMPOSTOR-UPDATE/pull/64
				...
				case 'Double Kill Events':
					switch(value1.toLowerCase()){
						...
						case 'readykill':
							...
							if(!usingBFSkin) triggerEventNote('Change Character', '0', 'bf-defeat-normal');
