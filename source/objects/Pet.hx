...
// basically a clone of Character
class Pet extends FlxSprite
{
	/**
	 * In case a character is missing, it will use this on its place
	**/
	public static final DEFAULT_PET:String = 'crab';
	...
	public function new(x:Float, y:Float, ?pet:String = 'bf')
	{
		super(x, y);
	...
	public function changePet(pet:String)
	{
		animationsArray = [];
		animOffsets = [];
		curPet = pet;
		var characterPath:String = 'pets/$pet.json';
		...
		#end
		{
			path = Paths.getSharedPath('pets/' + DEFAULT_PET + '.json'); //If a pet couldn't be found, change it to BF just to prevent a crash
		...
		{
			trace('Error loading pet file of "$pet": $e');
		}
	...
	public function loadCharacterFile(json:Dynamic)
	{
		...
		#end
		//trace('Loaded file to pet ' + curPet);
	}
	...
	public function playAnim(AnimName:String, Force:Bool = false, Reversed:Bool = false, Frame:Int = 0):Void
	{
		...
		if (curPet.startsWith('gf-') || curPet == 'gf')
		{
